...
[[maybe_unused]] static inline void setFooterLanguage(cfg::FooterLang lang) {
    ...
    [[maybe_unused]] static inline std::string buildFooterLegend() {
        return "\uE0E1  "s + getFooterBackLabel() + "     \uE0E0  "s + getFooterOkLabel();
    }
    ...
    namespace hlp {
        ...
        namespace ini {
             ...
             */
            static const char* CONFIG_FILE = "/config/ExtraHand/config.ini";
    ...
    namespace elm {
        ...
        public:
            ...
            virtual void draw(gfx::Renderer *renderer) override {
                ...
                const std::string footerLegend = tsl::buildFooterLegend();
                renderer->drawString(footerLegend.c_str(), false, 30, 693, 23, a(tsl::style::color::ColorText));
...
namespace tsl::cfg {
    ...
    FooterLang footerLang = FooterLang::English;
}
